...
describe("Add two number", () => {
    ...
    it("1 + 1 should be 2", () => {
        expect((0, math_1.add)(1, 1)).toBe(2);
    });
    /**
    ...
    it.skip("4 + 4 should be 8", () => {
        expect((0, math_1.add)(4, 4)).toBe(8);
    });
    /**
    ...
    it.each([
        ...
        expect((0, math_1.add)(a, b)).toBe(c);
    });
    /**
    ...
    describe.only.each([
        ...
        test(`returned value not be greater than ${expected}`, () => {
            expect((0, math_1.add)(a, b)).toBe(expected);
        });
        test(`returned value not be greater than ${expected}`, () => {
            expect((0, math_1.add)(a, b)).not.toBeGreaterThan(expected);
        });
        test(`returned value not be less than ${expected}`, () => {
            expect((0, math_1.add)(a, b)).not.toBeLessThan(expected);
        });
    });
});
