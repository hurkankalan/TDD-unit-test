import { add, addition, addition2 } from "./asynchrones-functions";
...
// Le test est passed
it("should be error", () => {
  return addition2(1, 1).catch((error) => expect(error).toBe("error"));
});
...
*/
it("should be error", () => {
  return expect(addition2(1, 2)).rejects.toBe("error");
});
...
*/
it("Shoulde be 100", () => {
  return expect(addition(50, 50)).resolves.toBe(100);
});
